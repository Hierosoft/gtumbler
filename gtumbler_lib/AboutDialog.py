...
class AboutDialog(Gtk.AboutDialog):
    ...
    def __new__(cls):
        ...
        """
        builder = get_builder('AboutGtumblerDialog')
        new_object = builder.get_object("about_gtumbler_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        to finish initializing the start of the new AboutGtumblerDialog
        instance.
