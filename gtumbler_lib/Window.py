...
# This class is meant to be subclassed by GtumblerWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseGtumblerWindow object.
        """
        builder = get_builder('GtumblerWindow')
        new_object = builder.get_object("gtumbler_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a GtumblerWindow object with it in order to finish
        initializing the start of the new GtumblerWindow instance.
        """
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('gtumbler')
        except ImportError:
            pass
        ...
        try:
            from gtumbler import indicator
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for gtumbler."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for gtumbler."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the GtumblerWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the GtumblerWindow is closed."""
